...
public class MovieSixthFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)  inflater.inflate(R.layout.fragment_movie_sixth, container, false);
    ...
    private void viewEvent() {
        btnMovieDetail.setOnClickListener(view -> {
            ...
            callback.onClickedViewsDetailButton(new Movie(name, "범죄, 액션", getString(R.string.contents6), R.drawable.image66, R.drawable.ic_19));
        });
    }
}