...
public class MovieFirstFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)  inflater.inflate(R.layout.fragment_movie_first, container, false);
    ...
    private void viewEvent() {
        btnMovieDetail.setOnClickListener(view -> {
            ...
            callback.onClickedViewsDetailButton(new Movie(name, "액션", getString(R.string.contents1), R.drawable.image11, R.drawable.ic_15));
        });
    }
}