...
public class MovieFifthFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)  inflater.inflate(R.layout.fragment_movie_fifth, container, false);
    ...
    private void viewEvent() {
        btnMovieDetail.setOnClickListener(view -> {
            ...
            callback.onClickedViewsDetailButton(new Movie(name, "코미디", getString(R.string.contents5), R.drawable.image55, R.drawable.ic_15));
        });
    }
}