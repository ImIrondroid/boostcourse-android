...
public class MovieThirdFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)  inflater.inflate(R.layout.fragment_movie_third, container, false);
    ...
    private void viewEvent() {
        btnMovieDetail.setOnClickListener(view -> {
            ...
            callback.onClickedViewsDetailButton(new Movie(name, "범죄, 드라마", getString(R.string.contents3), R.drawable.image33, R.drawable.ic_12));
        });
    }
}